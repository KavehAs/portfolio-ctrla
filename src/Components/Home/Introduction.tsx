...
export default function Introduction() {
  return (
    <div className='mt-6 flex-col items-center flex'>
      ...
      <span className='mt-4 sm:mt-0 text-greyText text-center block text-lg sm:text-xl'>سلام ! ما تیم کنترل ای هستیم{'\u2728'}</span>
      ...
      <Link to={"/about"}>
        <Button variant="contained" size='large' startIcon={<OpenInNewRoundedIcon className='ml-3' />} className='bg-lightBlack text-greyText border-greyText hover:border-lightText md:text-lg mt-4 sm:mt-0'>اطلاعات بیشتر</Button>
      </Link>
    </div>
  )
}
